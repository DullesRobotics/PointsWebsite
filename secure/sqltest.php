        ...
        <?php
            ...
            try{
                ...
                foreach ($MemberData as $member) {
                    ...
                    echo("<td><form action='updateDB.php' method='post'><input type='text' name='points' value='".$member['Points'] . "'><input type='submit' name=". $member['Tag_ID']. " value='Change ". $member['First_Name'] . "'></form></td>");
                    echo "</tr>";
                }
                echo "</table>";
